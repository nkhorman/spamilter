#!/bin/sh
#
# http://lists.apple.com/archives/scitech/2001/Jun/msg00016.html
#
...
echo "A man (help) page generator                    "
echo "-----------------------------------------------"
...
echo " (1) each flag (with the leading dashe(s) \`-') and"
...
echo ".TH $bname $section \"v\ $version\" \"$d\" \"\"" >> $file
