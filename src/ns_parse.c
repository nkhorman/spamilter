...
#ifndef lint
static char const rcsid[] = "$FreeBSD: src/lib/libc/net/ns_parse.c,v 1.3 1999/08/28 00:00:14 peter Exp $";
static char const cvsid[] = "@(#)$Id: ns_parse.c,v 1.5 2005/11/30 05:21:17 neal Exp $";
#endif
