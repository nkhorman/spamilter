 ...
 class pImage extends pDraw
  {
   ...
   function addToImageMap($Type,$Plots,$Color=NULL,$Title=NULL,$Message=NULL,$HTMLEncode=FALSE, $HrefOrOnClick=NULL)
    {
     ...
     if ( $HTMLEncode )
      {
       ...
       $Message = str_replace("&gt;",">",$Message);
       if(isset($HrefOrOnCLick))
         $HrefOrOnCLick = htmlentities($HrefOrOnClick, ENT_QUOTES, "ISO-8859-16");
      }
     ...
     elseif($this->ImageMapStorageMode == IMAGE_MAP_STORAGE_FILE)
      {
       ...
       fwrite($Handle, $Type.IMAGE_MAP_DELIMITER.$Plots.IMAGE_MAP_DELIMITER.$Color.IMAGE_MAP_DELIMITER.$Title.IMAGE_MAP_DELIMITER.$Message.IMAGE_MAP_DELIMITER.$HrefOrOnClick."\r\n");
       fclose($Handle);
      }
    }
